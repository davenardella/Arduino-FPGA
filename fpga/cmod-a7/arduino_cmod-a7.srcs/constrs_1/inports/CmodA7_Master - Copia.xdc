...
# Buttons
set_input_delay -clock sys_clk_pin 0 [get_ports push_btn_A]
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { push_btn_A }]; #IO_L19N_T3_VREF_16 Sch=btn[0]
...
#set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS33 } [get_ports { ja[2] }]; #IO_L4N_T0_D05_14 Sch=ja[2]
#set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { ja[3] }]; #IO_L9P_T1_DQS_14 Sch=ja[3]
...
set_output_delay -clock sys_clk_pin 0 [get_ports tm1638_stb]
set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports { tm1638_stb }]; #IO_L2P_T0_34 Sch=pio[26]

set_output_delay -clock sys_clk_pin 0 [get_ports tm1638_clk]
set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports { tm1638_clk }]; #IO_L2N_T0_34 Sch=pio[27]

set_output_delay -clock sys_clk_pin 0 [get_ports tm1638_dio]
set_input_delay -clock sys_clk_pin 0 [get_ports tm1638_dio]
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports { tm1638_dio }]; #IO_L1P_T0_34 Sch=pio[28]
...
set_property -dict { PACKAGE_PIN W5    IOSTANDARD LVCMOS33 } [get_ports { spi_sck }]; #IO_L12P_T1_MRCC_34 Sch=pio[36]
create_clock -add -name spi_clk_pin -period 83.33 [get_ports {spi_sck}];


set_input_delay -clock sys_clk_pin 0 [get_ports spi_ss]
set_property -dict { PACKAGE_PIN V4    IOSTANDARD LVCMOS33 } [get_ports { spi_ss }]; #IO_L11N_T1_SRCC_34 Sch=pio[37]
set_input_delay -clock sys_clk_pin 0 [get_ports spi_copi]
set_property -dict { PACKAGE_PIN U4    IOSTANDARD LVCMOS33 } [get_ports { spi_copi }]; #IO_L11P_T1_SRCC_34 Sch=pio[38]
set_output_delay -clock sys_clk_pin 0 [get_ports spi_cipo]
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { spi_cipo }]; #IO_L16N_T2_34 Sch=pio[39]
