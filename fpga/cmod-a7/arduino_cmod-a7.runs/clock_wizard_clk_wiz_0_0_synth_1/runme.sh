...
HD_PWD='D:/Projects/arduino-fpga/fpga/cmod-a7/arduino_cmod-a7.runs/clock_wizard_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_wizard_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_wizard_clk_wiz_0_0.tcl
